...
const AboutBlock = () => {
  return (
    <div id= "about" className="container mx-auto">
        <p className='text-4xl font-extrabold text-center mb-1 tracking-widest'>ABOUT ME</p>
  ...
  Discover my professional interests, personal passions, and the hobbies that drive my creativity and continuous learning.
      ...
      <div className="flex flex-row justify-between items-start mt-10 ml-20 gap-10">
        <div className="w-1/2">
          <AboutText />
        </div>
        <div className="w-1/2">
